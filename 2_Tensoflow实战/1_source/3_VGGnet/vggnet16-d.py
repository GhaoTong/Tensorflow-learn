...
def inference_op (input_op, keep_prob):
    ...
    resh1 = tf.reshape(pool5, [-1, flattened_shape,], name= "reh1")
    ...
    pridictions = tf.arg_max(softmax, 1)

    return pridictions, softmax, fc8, p
...
never_used = tf.placeholder(tf.float32,shape= [1,2])